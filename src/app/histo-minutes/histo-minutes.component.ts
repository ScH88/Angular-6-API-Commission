...
@Component({
  selector: 'app-histo-minutes',
  templateUrl: './histo-minutes.component.html',
  styleUrls: ['./histo-minutes.component.css']
})
export class HistoMinutesComponent implements OnInit {
  public fsym;
  public tsym;
  public limit;
